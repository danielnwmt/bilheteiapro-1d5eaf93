...
-- GRANT no nível da TABELA (não por coluna): colunas legadas como price_id
-- não podem quebrar SELECT * negando o acesso ao papel.
...
(
  ...
  '{"bilhetesIlimitados":true,"oddPersonalizada":true,"planilhaBanca":false,"favoritos":false,"estatisticasAvancadas":false,"tempoReal":false,"alertasInteligentes":false,"melhoresPicks":false,"suportePrioritario":false}'::jsonb
),
(
  ...
  '{"bilhetesIlimitados":true,"oddPersonalizada":true,"planilhaBanca":true,"favoritos":true,"estatisticasAvancadas":true,"tempoReal":false,"alertasInteligentes":false,"melhoresPicks":true,"suportePrioritario":false}'::jsonb
),
(
  'elite', 'BilheteIA Elite', 'R$ 79,90', 'Tudo, em tempo real e com suporte prioritário.', 3, 60,
  '["Brasileirão Série A","Brasileirão Série B","Premier League","Copa do Brasil","Libertadores","Sul-Americana","La Liga","Serie A (Itália)","Bundesliga","Ligue 1","Champions League","Europa League","Conference League","Copa do Mundo"]'::jsonb,
  '{"bilhetesIlimitados":true,"oddPersonalizada":true,"planilhaBanca":true,"favoritos":true,"estatisticasAvancadas":true,"tempoReal":true,"alertasInteligentes":true,"melhoresPicks":true,"suportePrioritario":true}'::jsonb
);
