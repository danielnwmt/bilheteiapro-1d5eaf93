          ...
          <div className="space-y-4">
            ...
            <div className="pt-6">
              ...
              <Card className="mb-4 border-primary/30 bg-card p-4">
                <Label className="text-sm font-semibold">Banco de pagamento</Label>
                <p className="text-xs text-muted-foreground">
                  O sistema está configurado para usar somente <b>Asaas</b> em Pix, boleto e cartão.
                </p>
              </Card>
              ...
              <Card className="mt-4 border-primary/30 bg-card p-4">
                ...
                <p className="mb-2 text-xs text-muted-foreground">
                  Configure esta URL no painel do Asaas para receber confirmações de pagamento.
                </p>
                <div className="flex gap-2">
                  <Input
                    type="text"
